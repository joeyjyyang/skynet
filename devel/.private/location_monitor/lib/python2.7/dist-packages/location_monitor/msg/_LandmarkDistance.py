...
"""autogenerated by genpy from location_monitor/LandmarkDistance.msg. Do not edit."""
import sys
...
class LandmarkDistance(genpy.Message):
  ...
  _type = "location_monitor/LandmarkDistance"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string name # Name of the landmark
