...
if("TRUE" STREQUAL "TRUE")
  set(navigator_SOURCE_PREFIX /home/joey/projects/skynet/src/navigator)
  set(navigator_DEVEL_PREFIX /home/joey/projects/skynet/devel/.private/navigator)
  ...
  set(navigator_INSTALL_PREFIX /home/joey/projects/skynet/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'joey <joeyyang.ai@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joey/projects/skynet/src/navigator/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/joey/projects/skynet/devel/.private/navigator/lib;/home/joey/projects/skynet/devel/lib;/opt/ros/kinetic/lib)
...
set(navigator_EXPORTED_TARGETS "")
